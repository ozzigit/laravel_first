                <section class="buttons block">
                    <div class="buttons__block">
                        <div class="buttons__left">
                            ...
                            <button
                                type="button"
                                class="button__dot active__button"
                            ></button>

                            <button type="button" class="button__dot"></button>
                            <button type="button" class="button__dot"></button>
                            -->
                        </div>
                        ...
                        <div class="buttons__right">
                            <svg
                                class="button__arrow left__arrow"
                                width="60"
                                height="60"
                                viewBox="0 0 60 61"
                                fill="none"
                            ...
                            <svg
                                class="button__arrow rotated__arrow right__arrow"
                                width="60"
                                height="61"
                                viewBox="0 0 60 61"
                                fill="none"
